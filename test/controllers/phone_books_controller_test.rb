...
class PhoneBooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone_book" do
    assert_difference('PhoneBook.count') do
      post phone_books_url, params: { phone_book: { contact: @phone_book.contact, phoneNumber: @phone_book.phoneNumber } }
    end
  ...
  test "should update phone_book" do
    patch phone_book_url(@phone_book), params: { phone_book: { contact: @phone_book.contact, phoneNumber: @phone_book.phoneNumber } }
